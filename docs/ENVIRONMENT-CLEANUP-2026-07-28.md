...
| B2 | Tests run somewhere | No workflow ran `npm test` — added a test job, `build` gated behind it. **Verified in CI by observation:** run 30412029053 shows `test (22): success`, `test (26): success` | ✅ |
